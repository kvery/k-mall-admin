...
const initOptions = ref({
  ...
  font_formats:
    '微软雅黑=Microsoft YaHei,PingFang SC,sans-serif;苹果苹方=PingFang SC,Microsoft YaHei,sans-serif;宋体=simsun,serif;仿宋体=FangSong,serif;黑体=SimHei,sans-serif;Arial=arial,helvetica,sans-serif;Arial Black=arial black,avant garde;',
  ...
  images_upload_handler: (blobInfo: any, success: (v: string) => {}, failure: (v: string) => {}) => {
    ...
    api.post('/storage/minio/upload', formData)
      .then((res: any) => {
        success(res.url);
      })
      .catch(() => {
